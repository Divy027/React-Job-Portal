    ...
    <div className='searchDiv grid gp-10 bg-greyIsh rounded-[10px] p-[3rem]'>
      ...
      <div className='secDiv flex items-center gap-10 justify-center mt-10'> 
         <div className='singleSearch flex items-center gap-2'> 
            <label htmlFor='relevance' className='text-[#80808080] font-semibold'> Sort by: </label>

            <select name="" id="relevance" className='bg-white rounded-[3px] 0x-4 py-1' > 
         ...
         <div className='singleSearch flex items-center gap-2'> 
            <label htmlFor='type' className='text-[#80808080] font-semibold'> Type: </label>

            <select name="" id="type" className='bg-white rounded-[3px] 0x-4 py-1' > 
         ...
         <div className='singleSearch flex items-center gap-2'> 
            <label htmlFor='level' className='text-[#80808080] font-semibold'> Level: </label>

            <select name="" id="level" className='bg-white rounded-[3px] 0x-4 py-1' > 
